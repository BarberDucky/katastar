...
class AdPageComponent extends Component<Props, State> {
    ...
    private openDetails(item: AdModel) {
        // const currentPath = this.props.router.location.pathname
        this.props.push(`/ads/${item.id}`)
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(AdPageComponent)
